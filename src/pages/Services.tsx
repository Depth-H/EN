...
const defaultServices = [
  {
    ...
    description: '공간의 분위기를 결정짓는 감성 조명 설계부터 에너지 효율을 고려한 LED 교체 공사까지, 호텔 브랜드 이미지에 맞는 최적의 조명 환경을 구축합니다.',
    features: ['객실 무드 조명 시스템', '로비/연회장 대형 조명 시공', '경관 조명 및 사인물 전기 공사']
  },
  {
    iconName: 'Zap',
    title: '전기 설비 및 동력 공사',
    description: '안정적인 전력 공급을 위한 수변전 설비부터 각 층별 분전반 설치, 비상 발전기 시스템 구축 등 건물의 심장부와 같은 전기 인프라를 완벽하게 시공합니다.',
    features: ['수변전 설비 신설 및 증설', '동력 배선 및 제어반 공사', 'UPS 및 비상 전원 시스템']
  },
  {
    iconName: 'Shield',
    title: '전기 안전 진단 및 정밀 점검',
    description: '안전은 타협할 수 없는 가치입니다. 최신 전기설비 기술기준을 준수하는 정밀 진단과 정기 점검을 통해 무사고 사업장을 실현합니다.',
    features: ['전기 설비 정밀 안전 진단', '노후 선로 누전 점검', '전기 안전 검사 대행 지원']
  },
  {
    iconName: 'Building2',
    title: '스마트 호텔 제어 시스템',
    description: 'IoT 기술을 접목하여 객실 내 조명, 냉난방, 커튼 등을 통합 제어하는 시스템을 구축합니다. 운영 효율성을 높이고 고객에게 차별화된 편의를 제공합니다.',
    features: ['객실 관리 시스템(RMS) 연동', '에너지 절감 자동 제어', '모바일 앱 통합 제어 솔루션']
  },
  {
    iconName: 'Cpu',
    title: '통신 및 네트워크 인프라',
    description: '고속 인터넷, Wi-Fi 6, IPTV 시스템 등 현대 호텔의 필수 인프라인 통신 설비를 안정적으로 구축하여 끊김 없는 디지털 환경을 제공합니다.',
    features: ['광케이블 및 LAN 선로 공사', '전 층 Wi-Fi 음영 지역 해소', '서버실 및 랙 장비 구성']
  },
  {
    iconName: 'Wrench',
    title: '정기 점검 및 유지보수',
    description: '시공 후에도 지속적인 관리를 통해 사고를 예방합니다. 24시간 긴급 출동 서비스와 정기적인 전기 안전 점검으로 비즈니스의 연속성을 보장합니다.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, i) => {
            ...
            return (
              ...
              >
                <Icon className="h-12 w-12 mb-8 text-foreground/40" />
